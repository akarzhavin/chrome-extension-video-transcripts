...
//
// Run:  node pipelines/store-i18n@1/check-clearance.mjs [locales…]
...
const COPY = JSON.parse(fs.readFileSync(path.join(ROOT, 'pipelines/store-i18n@1/assets/promo-copy.json'), 'utf8'));
...
for (const loc of locales) {
  const f = path.join(ROOT, '.build/store-i18n@1', loc, 'slide5.html');
